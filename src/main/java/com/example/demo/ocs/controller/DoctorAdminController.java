...
import com.example.demo.ocs.doctor.exception.DoctorNotFoundException;
...
public DoctorBean updateDoctor(@RequestBody DoctorBean doctorID)
{
 return ad.modifyDoctor(doctorID);
}
}